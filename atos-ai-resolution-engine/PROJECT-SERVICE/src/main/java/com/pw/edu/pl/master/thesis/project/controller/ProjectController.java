...
public class ProjectController {
    ...
    // UPDATE
    // ──────────────────────────────────────────────────────────────
    /** Update a project in Jira and refresh local DB by numeric id. */
    @PutMapping("/{id}")
    ...
    /** Update a project in Jira and refresh local DB by Jira key (e.g. ABC). */
    @PutMapping("/by-key/{projectKey}")
    public ResponseEntity<ProjectResponse> updateByKey(@PathVariable String projectKey, @RequestBody UpdateProjectRequest request
    ) {
        return ResponseEntity.ok(projectService.updateProjectByKey(projectKey, request));
    }
    ...
    public ResponseEntity<String> deleteByKey(@PathVariable String projectKey) {
        return ResponseEntity.ok(projectService.deleteProjectByKey(projectKey));
    }
