    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/wut/projects/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/wut/projects/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/wut/projects/**").permitAll()
