...
import com.pw.edu.pl.master.thesis.project.exceptions.DuplicateProjectKeyException;
...
public class ProjectServiceImplementation implements ProjectService {
    ...
    public ProjectResponse updateProject(Long id, UpdateProjectRequest request) {
        ...
        jiraClientConfiguration.put(updateUrl, body, Map.class, cred.getUsername(), cred.getToken());
