    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/wut/mcp/configurations/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/wut/mcp/configurations/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/wut/mcp/configurations/**").hasRole("ADMIN")
                        .requestMatchers(
                                "/actuator/**",
                                "/v3/api-docs/**",
                                "/swagger-ui/**",
