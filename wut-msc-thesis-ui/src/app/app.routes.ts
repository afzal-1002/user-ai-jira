...
import { AdminJiraDomainComponent } from './features/authentication/admin-jira-domain/admin-jira-domain.component';
import { AdminProjectsComponent } from './features/authentication/admin-projects/admin-projects.component';
import { AdminProjectFormComponent } from './features/authentication/admin-project-form/admin-project-form.component';
import { AdminCredentialsComponent } from './features/authentication/admin-credentials/admin-credentials.component';
import { AdminRepositoriesComponent } from './features/authentication/admin-repositories/admin-repositories.component';
...
import { AiSessionWorkspaceComponent } from './features/dashboard/ai-session-workspace/ai-session-workspace.component';
...
export const routes: Routes = [
    ...
    { path: 'dashboard', component: ProjectsHomeComponent, canActivate: [AuthGuard] },
    ...
    { path: 'issues', component: ProjectsHomeComponent, canActivate: [AuthGuard] },
    ...
    { path: 'issue-details/:issueKey/ai-copilot/:sessionId', component: AiSessionWorkspaceComponent, canActivate: [AuthGuard] },
    { path: 'mcp/issues/:issueKey/analysis', component: AiAnalysisPageComponent, canActivate: [AuthGuard] },
    { path: 'mcp/issues/:issueKey/copilot/:sessionId', component: AiSessionWorkspaceComponent, canActivate: [AuthGuard] },
    ...
    { path: 'admin/jira-domain', component: AdminJiraDomainComponent, canActivate: [AuthGuard, AdminGuard] },
    { path: 'admin/projects', component: AdminProjectsComponent, canActivate: [AuthGuard, AdminGuard] },
    { path: 'admin/projects/new', component: AdminProjectFormComponent, canActivate: [AuthGuard, AdminGuard] },
    { path: 'admin/projects/:projectKey/edit', component: AdminProjectFormComponent, canActivate: [AuthGuard, AdminGuard] },
    { path: 'admin/credentials', component: AdminCredentialsComponent, canActivate: [AuthGuard, AdminGuard] },
    { path: 'admin/repositories', component: AdminRepositoriesComponent, canActivate: [AuthGuard, AdminGuard] },
